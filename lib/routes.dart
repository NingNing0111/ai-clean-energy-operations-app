...
final routers = [
  ...
  GetPage(name: "/login", page: ()=>const LoginPage(),
    middlewares: [AuthMiddleware()],),
  GetPage(name: '/collectManager', page:()=>const CollectManager(),
      middlewares: [AuthMiddleware()]),
  GetPage(name: '/vehicleReport', page:()=>const VehicleReport(),
      middlewares: [AuthMiddleware()]),
  GetPage(name: '/refuelRecord', page:()=>const RefuelRecord(),
      middlewares: [AuthMiddleware()]),
  GetPage(name: '/maintenanceRecord', page:()=>const MaintenanceRecord(),
      middlewares: [AuthMiddleware()]),
  GetPage(name: '/ureaRefillRecord', page:()=>const UreaRefillRecord(),
      middlewares: [AuthMiddleware()]),
  GetPage(name: '/departureReport', page: () => const DepartureReportPage(),
  middlewares: [AuthMiddleware()])
];
